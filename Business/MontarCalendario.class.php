<?php
	class MontarCalendario
	{
		//private $ano = $_SESSION['anoExer'];
		...
		public static function MostreCalendario($mes,$objeto)
		{
			self::initialize();
			...
			self::MostreSemanas();	// função que mostra as semanas aqui
			echo "</tr>"; 
		...
		public static function MostreCalendarioView($mes)
		{
			self::initialize();
